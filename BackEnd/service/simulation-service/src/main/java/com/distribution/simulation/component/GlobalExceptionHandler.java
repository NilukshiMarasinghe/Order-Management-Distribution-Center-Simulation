...
import com.distribution.simulation.dto.response.wrapper.ValidationFailureResponseWrapper;
...
import  com.distribution.simulation.exception.EntityIdCryptoException;
import com.distribution.simulation.dto.response.wrapper.BaseResponseWrapper;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<BaseResponseWrapper> handleExceptions(Exception ex, WebRequest request) {
        return new ResponseEntity<>(new BaseResponseWrapper(RestApiResponseStatus.OK.ERROR),
